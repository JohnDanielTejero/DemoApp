    ...
    <div class="row">
        ...
        <div class = "col-8 row gy-3">
            ...
            <div>
                <div class="card mx-5">
                    <div class = "card-body">
                        <form class = "row gy-2" method="POST" action="{{ route('notes.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class = "col-12 form-floating">
                                <input class ="form-control w-100 @error('note_title') is-invalid @enderror" name = "note_title" value ="{{old( 'note_title') }}"/>
                            ...
                            <div class = "col-12 form-floating">
                                <textarea class ="form-control w-100 @error('notes') is-invalid @enderror" style="height:20rem;" name = "notes" value ="{{old( 'notes') }}"></textarea>
